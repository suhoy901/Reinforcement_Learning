...
class Game:
    ...
    def _get_state(self):
        ...
        state.append(self.car["col"])
        state.append(self.block[0]["col"])
        state.append(self.block[0]["row"])
        state.append(self.block[1]["col"])
        state.append(self.block[1]["row"])
...
if __name__ == "__main__":
    ...
    for i in range(100):
        ...
        while True:
            ...
            state, reward, done = env.step(random.randrange(3))
