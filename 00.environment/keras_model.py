...
#
# 먼저 plot_decision_boundary 라는 함수를 정의합니다.
# 이 함수에 대해서는 이해하지 않으셔도 좋습니다.
# Classification 모델을 넣으주면 모델이 데이터를 어떻게 나누고 있는 지 시각화해주는 함수입니다.
...
# 이제 keras.utils.np_utils 에서 to_categorical 이라는 함수를 불러옵니다.
# 이 함수가 어떤 역할을 하는 지는 다음 출력값을 보시면 쉽게 이해하실 수 있을 겁니다.

y_binary = to_categorical(y)
print("y : ", y)
print("y_binary : ", y_binary)

# 이제 모델을 만들었으니 이 모델을 train 시키기 위한 loss와  optimizer을 설정해줍니다.
# 이러한 부분을 쉽게 설정해 주는 것이 바로 model.compile이라는 함수입니다.
